...
public class ContactListAdapter extends
    ...
    public void onBindViewHolder(@NonNull ContactViewHolder holder, int position) {
        ...
        holder.edit.setOnClickListener(view -> {
            itemClickListener.onEditButtonClick(contact, position);
        });

        holder.delete.setOnClickListener(view -> {
            itemClickListener.onDeleteButtonClick(contact, position);
        });
        holder.itemView.setOnLongClickListener(view -> {
            itemClickListener.onContactLongPress(contact, position);
            return false;
        });
    }
    ...
    public interface ItemClickListener {
        ...
        void onEditButtonClick(Contact item, int pos);

        void onDeleteButtonClick(Contact item, int pos);

        void onContactLongPress(Contact item, int pos);
    }
